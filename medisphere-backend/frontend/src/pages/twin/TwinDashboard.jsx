  ...
  return (
    <div className="twin360-shell">
      <style>{`
        ...
        .twin360-topbar {
          background: linear-gradient(90deg, #2f6fed, #4c86f5);
        ...
        .twin360-heading { color: #eef2f8; font-weight: 700; }
        .twin360-stat-grid {
          display: grid;
        ...
        .twin360-stat-label { font-size: 0.75rem; color: #8b97ab; }
        .twin360-stat-value {
        ...
        .twin360-stat-sub { font-size: 0.72rem; color: #4c86f5; }
