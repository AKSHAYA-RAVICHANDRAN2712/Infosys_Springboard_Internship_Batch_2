...
const mockKafka = require("./kafka/mockKafka");

// Send live updates every 5 seconds

setInterval(() => {

    io.emit("kafka-update", {

        vitals: mockKafka.getVitals(),

        events: mockKafka.getEvents()
...
server.listen(PORT, () => {
    ...
    console.log("================================");
    console.log("MediSphere Backend Started");
    console.log("Kafka Mode : SIMULATION");
