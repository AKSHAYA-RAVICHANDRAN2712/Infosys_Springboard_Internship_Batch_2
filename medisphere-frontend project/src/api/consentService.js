...
export function getConsents(patientId) {
  return Promise.resolve(consentState)
}

export function updateConsent(patientId, consentId, granted) {
...
export function getAuditLog(patientId) {
 ...
 */
export function verifyConsent(payload) {
  const errors = []
